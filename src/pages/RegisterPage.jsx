...
const RegisterPage = () => {
  ...
  const steps = [
    { id: 1, title: "Personal Info", icon: User, description: "Enter your full name as on ID" },
    { id: 2, title: "Upload ID", icon: Upload, description: "Upload clear ID card photo" },
    { id: 3, title: "Verification", icon: Shield, description: "Automatic verification process" },
    { id: 4, title: "Complete", icon: CheckCircle, description: "Verification successful" }
  ];
  ...
  const extractNameFromKTP = (text) => {
    ...
    if (nameLine) {
      const name = nameLine.split(/nama\s*[:=]/i)[1]?.trim()?.toLowerCase();
      return name || "";
    }
    return "";
  };
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="text-center mb-8">
        ...
        <h1 className="text-3xl font-bold text-purple-900 mb-2">KYC Verification</h1>
            ...
            return (
              <div key={step.id} className="flex-1">
                ...
                <div className="mt-3 text-center">
                  <p className={`font-semibold text-sm ${isActive ? 'text-purple-600' : isCompleted ? 'text-green-600' : 'text-gray-500'}`}>
                    {step.title}
                  </p>
                </div>
              </div>
        ...
        {currentStep === 1 && (
          <div className="p-6">
            <div className="text-center mb-6">
              ...
              <h2 className="text-xl font-bold text-purple-900 mb-2">Personal Information</h2>
              <p className="text-gray-600">Enter your full name as it appears on your ID card</p>
            </div>
        ...
        {currentStep === 2 && (
          <div className="p-6">
            <div className="text-center mb-6">
              ...
              <h2 className="text-xl font-bold text-purple-900 mb-2">Upload ID Card Photo</h2>
              <p className="text-gray-600">Make sure the ID card photo is clear and readable</p>
            </div>
              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    {ktpFile ? (
                      <div>
                        <p className="text-purple-600 font-semibold text-sm">{ktpFile.name}</p>
                        <p className="text-xs text-gray-500 mt-1">File successfully selected</p>
                      </div>
                    ) : (
                      <div>
                        <p className="text-gray-600 font-semibold text-sm">Click to upload ID card</p>
          ...
          <div className="p-6">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 text-sm">
                {loading ? "Processing OCR and matching data..." : "Verification process completed"}
              </p>
            </div>
            ...
            <div className="max-w-lg mx-auto">
              ...
              {ocrName && !loading && (
                <div className="bg-gray-50 rounded-xl p-4 mb-4">
                  <h4 className="font-semibold text-gray-800 mb-3 text-sm">Verification Details:</h4>
                  <div className="space-y-2 text-xs">
                    ...
                    <div>
                      <span className="text-gray-600">Normalization status:</span>
                      <span className={`ml-2 font-semibold ${
                        normalizeName(ocrName) === normalizeName(fullName) ? 'text-green-600' : 'text-red-600'
                      }`}>
                        {normalizeName(ocrName) === normalizeName(fullName) ? 'Match' : 'No Match'}
                      </span>
                    </div>
                  </div>
                </div>
        ...
        {currentStep === 4 && (
          <div className="p-6">
            <div className="text-center">
              ...
              <h2 className="text-2xl font-bold text-green-600 mb-3">Verification Successful!</h2>
              <p className="text-gray-600 mb-6">
                Your identity has been successfully verified. You can now proceed to the next process.
              </p>

              <div className="bg-green-50 border-2 border-green-200 rounded-xl p-4 max-w-md mx-auto mb-6">
                <div className="flex items-center justify-center gap-2 mb-3">
                  <FileText className="w-5 h-5 text-green-600" />
                  <h3 className="font-semibold text-green-800 text-sm">Verification Details</h3>
                </div>
        ...
        {ocrText && currentStep === 3 && !loading && (
          <div className="border-t-2 border-gray-100 p-6 bg-gray-50">
            <details className="cursor-pointer">
              <summary className="font-semibold text-gray-700 mb-4">🧾 Detail Hasil OCR</summary>

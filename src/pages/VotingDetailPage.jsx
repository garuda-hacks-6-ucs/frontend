...
const VotingDetailPage = () => {
    ...
    useEffect(() => {
        if (id) {
            ...
            const sortedVendors = projectVendors.sort((a, b) => b.voteCount - a.voteCount);
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                <div className="lg:col-span-2">
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-8">
                        {voting.images.map((img, index) => (
                            <div
                                key={index}
                                className={`rounded-lg overflow-hidden border transition-all duration-200 cursor-pointer ${currentImageIndex === index
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-gray-100">
                        <h3 className="text-2xl font-bold text-purple-900 mb-4">Project AI Summary</h3>
                        <p className="text-gray-700 leading-relaxed text-lg">{voting.description}</p>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-gray-100">
                        <div className="mb-6">
                            <span
                                className={`px-4 py-2 rounded-full text-sm font-semibold ${voting.status === 'voting'
                                    ? 'bg-green-500 text-white'
                                    : 'bg-red-500 text-white'
                                    }`}
                            >
                                {voting.status === 'voting' ? 'Voting Active' : 'Voting Expired'}
                            </span>
                        </div>

                        <h1 className="text-3xl font-bold text-purple-900 mb-4">{voting.title}</h1>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="font-bold text-2xl text-purple-900">{voting.budget} ETH</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p
                                        className={`font-semibold ${voting.status === 'voting' ? 'text-green-600' : 'text-red-600'
                                            }`}
                                    >
                                        {voting.countdown}
                                    </p>
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-lg border-2 border-gray-100">
                        <h3 className="text-lg font-bold text-purple-900 mb-4">Project Documents</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-gray-100 mt-12">
                <div className="flex items-center justify-between mb-6">
                    <h3 className="text-2xl font-bold text-purple-900">Applied Vendors</h3>
                        ...
                        return (
                            <div
                                ...
                                className={`relative border rounded-xl p-6 cursor-pointer shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 
                                    ${isWinner ? 'border-yellow-400 ring-2 ring-yellow-400 bg-gradient-to-br from-yellow-50 to-orange-50' : 'border-gray-200 hover:border-purple-300'
                                    }`}
                            >
                                {isWinner && (
                                ...
                                <div className={`absolute top-4 left-4 rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold
                                ...
                                <div className="space-y-3">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500 mt-1">by {vendor.vendorName}</p>
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-sm font-medium text-gray-600">
                                                {vendor.voteCount} vote{vendor.voteCount !== 1 ? 's' : ''}
                                            </span>
                                        </div>
                                        
                                        <div className="text-right">
                                            <p className="text-lg font-bold text-purple-900">{vendor.budget} ETH</p>
                                        </div>
                                    </div>
                ...
                {vendors.length === 0 && (
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-400 text-sm">Applications will appear here once vendors submit their proposals</p>
                    </div>
                )}
            </div>
        </div>
